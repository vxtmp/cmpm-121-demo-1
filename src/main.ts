...
app.append(document.createElement("br"));
buyLv1QuackerButton.innerHTML = "Buy AutoQuacker: 10 quacks";
buyLv1QuackerButton.addEventListener("click", buy_one_quacker);
app.append(buyLv1QuackerButton);
app.append(lv1text);

app.append(document.createElement("br"));
buyLv2QuackerButton.innerHTML = "Buy Lv2 AutoQuacker: 100 quacks";
buyLv2QuackerButton.addEventListener("click", buy_two_quacker);
app.append(buyLv2QuackerButton);
app.append(lv2text);

app.append(document.createElement("br"));
buyLv3QuackerButton.innerHTML = "Buy Lv3 AutoQuacker: 1000 quacks";
...
function framebasedIncrement(timestamp: number) {
  ...
  const increment = lv1Counter * LV1_INCREMENT + lv2Counter * LV2_INCREMENT + lv3Counter * LV3_INCREMENT;
